...
Remember to always use a message with warnings, in order to make them meaningful. (See more in `use_with_warnings_doctest.rst <https://github.com/nyggus/easycheck/tree/master/docs/use_with_warnings_doctest.rst>`_).
...
You will find more about using :code:`easycheck` in `use_with_testing_doctest.rst <https://github.com/nyggus/easycheck/tree/master/docs/use_with_testing_doctest.rst>`_.
