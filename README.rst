...
* Version 0.11.0 came with a change in the building backend, from setup.py-based to pyproject.toml- and `build`-based. Several documentation tests have been also fixed.
